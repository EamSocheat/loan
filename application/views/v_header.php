...
<style type="text/css">
    ...
    body { font-family: 'Source Sans Pro','Helvetica Neue',Helvetica,Arial,sans-serif, Khmer Os Battambang; }
	...
	.mdl-msg .modal-header .close { margin-top: -25px; }
    label{ font-weight: 500; }
	.form-control{ border-radius: 5px; }
    textarea{ border-radius: 5px; }
    .input-sm{ border-radius: 3px; }
    		...
    		<a href="" class="logo">
        		...
        		<span class="logo-mini">
        			<div class="pull-left image">
        				<!-- <img src="<?php echo base_url('assets/') ?>dist/img/pack-money.png" class="img-circle" style="width: 40px;" alt="User Image"> -->
        			</div>
        		</span>
                    ...
                    <!-- Notifications: style can be found in dropdown.less -->
              			<li class="dropdown notifications-menu" id ="divExRate" style="cursor: default;">
                			<a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" style="cursor: default;">
                  				<span data-i18ncd="lb_exchange_rate">Exchange Rate ៛: </span> <input style="height: 20px;width: 50px;   border-radius: 5px; padding: 2px;" type="text" id="exRate" disabled="disabled" maxlength="4"> 
                        ...
                        <!-- User Account: style can be found in dropdown.less -->
              			<li class="dropdown user user-menu">
                			<a href="javascript:" class="dropdown-toggle" data-toggle="dropdown">
                  				...
                  				<span class="hidden-xs comName">Company Name</span>
                			</a>
                			<ul class="dropdown-menu">
                                <!-- User image -->
                      			<li class="user-header">
                        			<img src="<?php echo base_url('assets/') ?>dist/img/pack-money.png" class="img-circle" alt="User Image">
                        			<p>The E-Loan in Country<small>Since Jan. 2010</small></p>
                      			</li>
                                <!-- Menu Body -->
        						<li class="user-body">
                        			<div class="row">
