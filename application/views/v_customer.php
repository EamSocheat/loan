				...
				<div class="row">
					<div class="col-xs-12">
                        <div class="col-xs-12" style="display: flex;">
                            ...
                            <!-- <button type="button" id="btnDownExcel" class="btn btn-success btn-sm"><i class="fa fa-download" aria-hidden="true"></i> <span data-i18ncd="btn_excel">Download Excel</span></button> -->
                            <div style="margin-left: 5px;">
                                <form method="post" action="<?php echo base_url(); ?>Customer/download_excel">
                                    <input type="submit" name="export" class="btn btn-success" value="Download Excel" />
                                </form>
                            </div>
                        </div>
