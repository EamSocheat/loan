<?php include 'v_popup_header.php';?>
    ...
    border-bottom-right-radius: 5px;"><i class="fa fa-search-plus"></i></span>
                			...
                			<div class="form-group">
                              ...
                              <input  type="text" class="form-control" id="txtAccNm" name="txtAccNm" />
                            </div>
                		</div>
                		
                		<div class="col-xs-6 padding-forms-right">
                			<div class="form-group">
	                			<label for="braNm2" data-i18ncd="lb_staff">Staff Name</label>
                				<div class="input-group">
                                	<input type="text" class="form-control input-sm" disabled="disabled" id="txtBraNm" name="txtStaNm">
                                    <span id="btnPopupStaff" class="input-group-addon label-info" style="cursor: pointer;border-color: #46b8da !important;    border-top-right-radius: 5px;
    border-bottom-right-radius: 5px;"><i class="fa fa-search-plus"></i></span>
                                </div>
                                <input type="hidden" id="txtStaId" name="txtStaId">
                            </div>
                			<!--  -->
                			<div class="form-group">
